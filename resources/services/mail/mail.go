...
func Ticket() *schema.Table {
	return &schema.Table{
		Name:          "mail",
		Resolver:      fetchMail,
		Transform:     transformers.TransformWithStruct(&mail.Mail{}),
		IsIncremental: true,
...
func fetchMail(ctx context.Context, meta schema.ClientMeta, parent *schema.Resource, res chan<- interface{}) error {
